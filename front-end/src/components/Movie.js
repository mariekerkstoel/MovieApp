  ...
  render(){
    return(
      <div>
          ...
          <button className='rankButtonUp' onClick={(event)=> {this.props.handleRankUp(this.props.movie, event)}}>▲</button>
          <button className='rankButtonDown' onClick={(event)=> {this.props.handleRankDown(this.props.movie, event)}}>▼</button>
